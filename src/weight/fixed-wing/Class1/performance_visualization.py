...
def make_into_weight_arrays(result: dict):
    """
    Function to put the data from the Class I resultant weights file into a numpy array
...
def make_into_fractional_arrays(result: dict):
    """
    Function to put the data from the Class I resultant fractions file into a numpy array
    :param result: Dictionary obtained from the class_i_range_n_endurance function
    :return: numpy array with loiter and cruise speed, and payload fraction
    """
...
def plot_fractions(propulsion_type: str = 'propeller', *names):
    """
    Main plotting function for fractional data
...
def plot_weights(propulsion_type: str = 'propeller', *names):
    """
    Main plotting function for weight data
    :param propulsion_type: propeller or jet
    :param names: roskam category names
    :return: None
    """
